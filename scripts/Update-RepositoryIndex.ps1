...
$incomplete = @(
    ...
    'Algorithms/Matrix/Easy/LargestLocalValuesInAMatrix.cs',
    'Algorithms/Matrix/Medium/CountSquareSubmatricesWithAllOnes.cs',
    'Algorithms/Matrix/Medium/DifferenceBetweenOnesAndZerosInRowAndColumn.cs',
    'Algorithms/Matrix/Medium/SortMatrixByDiagonals.cs',
    ...
    'Algorithms/DynamicProgramming/Easy/TotalWavinessOfNumbersInRangeI.cs',
    'Algorithms/DynamicProgramming/Medium/PalindromePartitioning.cs',
    ...
    'Algorithms/HashTable/Medium/DividePlayersIntoTeamsOfEqualSkill.cs',
    ...
    'Algorithms/Math/Easy/NumberOfElapsedSecondsBetweenTwoTimes.cs',
...
$needsReview = @(
    ...
    'Algorithms/Math/Easy/SmallestNumberWithAllSetBits.cs',
